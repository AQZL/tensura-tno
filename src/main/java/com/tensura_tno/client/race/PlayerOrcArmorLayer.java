...
/**
 * Player-specific armor layer for the Tensura orc model. The render proxy has
 * no inventory, so armor stacks are read from the real player.
 */
final class PlayerOrcArmorLayer extends GeoRenderLayer<PlayerOrcAnimatable> {
    ...
    private static final String BODY = "ChestArmor";
    ...
    PlayerOrcArmorLayer(GeoRenderer<PlayerOrcAnimatable> renderer) {
        super(renderer);
    }

    @Override
    public void preRender(PoseStack poseStack, PlayerOrcAnimatable animatable,
    ...
    @Override
    public void renderForBone(PoseStack poseStack, PlayerOrcAnimatable animatable,
